...
# 3. Refresh Unity and wait until the editor is ready
refresh_unity(
    mode="if_dirty",
    scope="all",
    compile="request",
...
if console["messages"]:
    # Manually open the script file and fix the reported errors
...
# 2. Inspect the current code manually
# Locate the method, field, or class section that needs to be changed.

# 3. Edit the script manually
# Example replacement for Update():
